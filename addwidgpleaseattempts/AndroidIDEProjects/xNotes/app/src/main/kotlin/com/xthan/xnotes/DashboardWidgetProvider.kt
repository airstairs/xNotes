...
class DashboardWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        fun updateWidgetView(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            ...
            // Hook up the RemoteViewsService adapter to your ListView
            ...
            // Optional: Set empty view if the list has no notebooks
            //views.setEmptyView(R.id.widget_notebook_list, R.id.widget_empty_view)
